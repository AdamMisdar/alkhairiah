...
<style>
	...
	<form action="" method="get">
		<input type="text" class="form-control" name="query" placeholder="Cari tempahan mengikut nama/tarikh..">
	 	<button name="search" formaction="client-list.jsp" class="button" style="position: absolute; top: 5px; right:-100px; padding: 15px; padding-top: 7px; padding-bottom: 7px;">CARI</button>
	</form>
	<form action="" method="get">
		<input type="hidden" name="query" value="">
	 	<button name="q" formaction="client-list.jsp" class="button" style="position: absolute; top: 50px; right:-100px; padding: 15px; background-color: #db0f31; color: white;  padding: 7px">RESET</button>
	</form>	
	</div>
			...
			<tr>
				...
				<td>
					<form method="post">
						...
						<button name="view" id="tambah" formaction="view-client-account-management.jsp">LIHAT</button>
						<button name="delete" id="kosongkan" formaction="ClientHandler?action=deleteClient">PADAM</button>
					</form>
				</td>
			</tr>
			</c:forEach>	
